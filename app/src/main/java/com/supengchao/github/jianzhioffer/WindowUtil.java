...
public class WindowUtil {
    ...
    public static boolean setWidth(View view, int designedWidthResId) {
        float designedWidth = MyApplication.getInstance().getResources().getDimension(designedWidthResId);
    ...
    public static boolean setHeight(View view, int designedHeightResId) {
        if (view == null)
            return false;
        float designedHeight = MyApplication.getInstance().getResources().getDimension(designedHeightResId);
        LayoutParams params = null;
        if (view instanceof ViewGroup)
            params = view.getLayoutParams();
        if (params == null)
    ...
    public static boolean setTextSize(TextView view, int designedTextSizeResId) {
        if (view == null)
            return false;
        float designedSize = MyApplication.getInstance().getResources().getDimension(designedTextSizeResId);
    ...
    public static float getHorizontalScaledDimen(int heightResId) {
        return MyApplication.getInstance().getResources().getDimension(heightResId) * SCALE_RATIO_HORIZONTAL;
    }
    ...
    public static float getVerticalScaledDimen(int heightResId) {
        return MyApplication.getInstance().getResources().getDimension(heightResId) * SCALE_RATIO_VERTICAL;
    }
    ...
    public static int sp2px(float sp) {
        float f = MyApplication.getInstance().getResources().getDisplayMetrics().scaledDensity;
        return (int) (sp * f + 0.5f);
    }
     ...
     * @return
     */
    public static float computeScaledDimenByBalancedRatio(int resId) {
        return computeScaledDimen(resId, SCALE_RATIO);
    }
